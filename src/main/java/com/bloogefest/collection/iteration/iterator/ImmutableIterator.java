...
public interface ImmutableIterator<T> {
    ...
    /**
     * Возвращает {@linkplain Lock инструмент для управления доступом} к текущему итератору.
     *
     * @return {@linkplain Lock Инструмент для управления доступом} к текущему итератору.
     *
     * @since 1.0.0-RC1
     */
    @Contract("-> const")
