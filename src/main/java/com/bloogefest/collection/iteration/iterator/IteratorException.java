...
public class IteratorException extends SequentialIterationException {
    ...
    /**
     * Создаёт исключение итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения},
    ...
    /**
     * Создаёт исключение итератора на основе переданного сообщения, {@linkplain #DEFAULT_CAUSE причины},
    ...
    /**
     * Создаёт исключение итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения по умолчанию}, переданной причины,
     * {@linkplain #DEFAULT_SUPPRESSION параметров подавления} и
     * {@linkplain #DEFAULT_WRITABLE трассировки стека по умолчанию}.
     *
     * @param cause причина.
    ...
    /**
     * Создаёт исключение итератора на основе переданного сообщения и причины,
     * {@linkplain #DEFAULT_SUPPRESSION параметров подавления} и
     * {@linkplain #DEFAULT_WRITABLE трассировки стека по умолчанию}.
     *
     * @param message сообщение.
    ...
    /**
     * Создаёт исключение итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения} и
    ...
    /**
     * Создаёт исключение итератора на основе переданного сообщения, {@linkplain #DEFAULT_CAUSE причины по умолчанию},
    ...
    /**
     * Создаёт исключение итератора на основе переданного сообщения, причины, параметров подавления и трассировки
     * стека.
     *
     * @param message сообщение.
     * @param cause причина.
