...
public class IteratorElementCuttingException extends IteratorElementException {
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе сообщения, параметров подавления и трассировки стека.
     *
     * @param message сообщение.
     * @param suppression параметр подавления.
     * @param writable параметр трассировки стека.
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе сообщения, причины, параметров подавления и трассировки
     * стека.
     *
     * @param message сообщение.
     * @param cause причина.
