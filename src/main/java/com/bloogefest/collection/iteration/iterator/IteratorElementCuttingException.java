...
public class IteratorElementCuttingException extends IteratorElementException {
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения},
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе переданного сообщения,
     * {@linkplain #DEFAULT_CAUSE причины}, {@linkplain #DEFAULT_SUPPRESSION параметров подавления} и
     * {@linkplain #DEFAULT_WRITABLE трассировки стека по умолчанию}.
     *
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения по умолчанию},
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе переданного сообщения и причины,
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения} и
    ...
    /**
     * Создаёт исключение вырезания элемента итератора на основе переданного сообщения, причины, параметров подавления и
     * трассировки стека.
     *
     * @param message сообщение.
     * @param cause причина.
