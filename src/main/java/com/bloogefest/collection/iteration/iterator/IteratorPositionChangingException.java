...
public class IteratorPositionChangingException extends IteratorPositionException {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNls @NotNull String DEFAULT_MESSAGE = "Failed to change the iterator position";
    ...
    /**
     * Создаёт исключение изменения итератора на основе переданного сообщения, {@linkplain #DEFAULT_CAUSE причины},
    ...
    /**
     * Создаёт исключение изменения итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения по умолчанию}, переданной
    ...
    /**
     * Создаёт исключение изменения итератора на основе переданного сообщения и причины,
     * {@linkplain #DEFAULT_SUPPRESSION параметров подавления} и
     * {@linkplain #DEFAULT_WRITABLE трассировки стека по умолчанию}.
     *
     * @param message сообщение.
    ...
    /**
     * Создаёт исключение изменения итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения} и
    ...
    /**
     * Создаёт исключение изменения итератора на основе переданного сообщения,
     * {@linkplain #DEFAULT_CAUSE причины по умолчанию}, переданных параметров подавления и трассировки стека.
     *
     * @param message сообщение.
     * @param suppression параметр подавления.
    ...
    /**
     * Создаёт исключение изменения итератора на основе переданного сообщения, причины, параметров подавления и
     * трассировки стека.
     *
     * @param message сообщение.
     * @param cause причина.
