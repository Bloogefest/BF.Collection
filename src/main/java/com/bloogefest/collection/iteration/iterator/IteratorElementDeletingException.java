...
public class IteratorElementDeletingException extends IteratorElementException {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NotNls @NotNull String TEMPLATE_MESSAGE = "Failed to delete %s";

    /**
     * Создаёт исключение удаления элемента итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения},
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе переданного сообщения,
     * {@linkplain #DEFAULT_CAUSE причины}, {@linkplain #DEFAULT_SUPPRESSION параметров подавления} и
     * {@linkplain #DEFAULT_WRITABLE трассировки стека по умолчанию}.
     *
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения по умолчанию},
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе переданного сообщения и причины,
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе {@linkplain #DEFAULT_MESSAGE сообщения} и
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе переданного сообщения, причины, параметров подавления и
     * трассировки стека.
     *
     * @param message сообщение.
     * @param cause причина.
