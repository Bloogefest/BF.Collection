...
public class IteratorElementDeletingException extends IteratorElementException {
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе сообщения, параметров подавления и трассировки стека.
     *
     * @param message сообщение.
     * @param suppression параметр подавления.
     * @param writable параметр трассировки стека.
    ...
    /**
     * Создаёт исключение удаления элемента итератора на основе сообщения, причины, параметров подавления и трассировки
     * стека.
     *
     * @param message сообщение.
     * @param cause причина.
